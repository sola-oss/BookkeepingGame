...
const diagram = `export default function CostClassificationDiagram() {
  return (
...
writeFileSync('/home/runner/workspace/client/src/components/textbook/CostClassificationDiagram.tsx', diagram);
console.log('Step1 done');

let tbl = readFileSync('/home/runner/workspace/client/src/pages/TextbookList.tsx', 'utf8');
if (!tbl.includes('CostClassificationDiagram')) {
  tbl = tbl.replace(
  ...
  writeFileSync('/home/runner/workspace/client/src/pages/TextbookList.tsx', tbl);
  console.log('Step2 done');
} else { console.log('Step2 already done'); }

let tbp = readFileSync('/home/runner/workspace/client/src/data/textbookPages.ts', 'utf8');
if (!tbp.includes('"cost-classification"')) {
  tbp = tbp.replace(
    'id: "cost_classification",',
    'id: "cost_classification",\n          diagramId: "cost-classification",'
  );
  writeFileSync('/home/runner/workspace/client/src/data/textbookPages.ts', tbp);
  console.log('Step3 done');
} else { console.log('Step3 already done'); }
