                ...
                <div className="w-full flex-1 bg-muted/20 rounded-lg relative overflow-hidden flex gap-0.5 border border-primary/20">
                   <div className="flex-1 flex flex-col gap-0.5 h-full">
                     ...
                     <motion.div 
                       ...
                       className="w-full bg-white dark:bg-zinc-800 flex items-center justify-center text-zinc-600 dark:text-zinc-400 font-bold text-[8px] z-10 border-t border-zinc-200 dark:border-zinc-700"
                     >
                       当期純利益
                     </motion.div>
                   </div>
