      ...
      <div className="flex items-center justify-between gap-4">
          ...
          <AnimatePresence mode="wait">
            {combo > 1 && (
              <motion.div
                ...
                className="flex items-center gap-1 px-2 py-1 rounded-full bg-orange-100 dark:bg-orange-900/50"
        ...
        <div className="flex items-center gap-4">
          {showTime && timeLeft !== undefined && (
            <div className="flex items-center gap-1" data-testid="time-display">
