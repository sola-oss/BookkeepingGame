...
function PLRydeen() {
  return (
    <div className="overflow-x-auto">
      <div className="min-w-[500px] p-2 border border-slate-300 dark:border-slate-600 rounded space-y-2 text-[10px]">
        <div className="flex gap-[1px] bg-slate-300 dark:bg-slate-600 border border-slate-300 dark:border-slate-600 rounded overflow-hidden">
          <div className="flex-1 bg-background p-2 space-y-1">
            <div className="font-bold text-center text-muted-foreground mb-1 text-[9px]">（費用）</div>
            <div className="rounded p-1.5 bg-green-100 dark:bg-green-900/60 space-y-0.5">
          ...
          <div className="flex-1 bg-background p-2 flex flex-col">
            <div className="font-bold text-center text-muted-foreground mb-1 text-[9px]">（収入）</div>
            <div className="flex-1 rounded p-1.5 bg-orange-100 dark:bg-orange-900/60 flex flex-col justify-center space-y-0.5">
        ...
        <div className="border-2 border-green-400 dark:border-green-600 rounded p-1.5 bg-green-50 dark:bg-green-950/30">
          <Row label="粗利（売上高 − 変動費）" amount={150507634} bold />
        </div>

        <Row label="営業利益" amount={19508529} bold borderTop />

        <div className="rounded p-1.5 bg-orange-50 dark:bg-orange-900/30 space-y-0.5">
        ...
        <div className="bg-slate-100 dark:bg-slate-800 rounded p-2 mt-1 space-y-0.5">
