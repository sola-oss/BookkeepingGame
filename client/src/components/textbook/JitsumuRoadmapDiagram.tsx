    ...
    <div className="w-full p-2 md:p-4" data-testid="jitsumu-roadmap-diagram">
      ...
      <div className="w-full overflow-x-auto">
        <svg width="100%" viewBox="0 0 680 340" xmlns="http://www.w3.org/2000/svg">
          ...
          <text x="100" y="84" textAnchor="middle" fontSize="12" fontWeight="700" fill="#4c1d95">発生主義を</text>
          <text x="100" y="99" textAnchor="middle" fontSize="12" fontWeight="700" fill="#4c1d95">理解する</text>
          <text x="100" y="116" textAnchor="middle" fontSize="10" fill="#7c3aed">現金主義との違い</text>
          <text x="100" y="131" textAnchor="middle" fontSize="10" fill="#7c3aed">発生主義の原則</text>
          ...
          <text x="264" y="84" textAnchor="middle" fontSize="11" fontWeight="700" fill="#831843">期をまたぐと</text>
          <text x="264" y="99" textAnchor="middle" fontSize="11" fontWeight="700" fill="#831843">何が起きるか</text>
          <text x="264" y="116" textAnchor="middle" fontSize="10" fill="#be185d">前払い・未払い</text>
          <text x="264" y="131" textAnchor="middle" fontSize="10" fill="#be185d">期間のズレ</text>
          ...
          <text x="428" y="84" textAnchor="middle" fontSize="11" fontWeight="700" fill="#92400e">当期分を正確に</text>
          <text x="428" y="99" textAnchor="middle" fontSize="11" fontWeight="700" fill="#92400e">対応させる</text>
          <text x="428" y="116" textAnchor="middle" fontSize="10" fill="#d97706">期間損益計算</text>
          <text x="428" y="131" textAnchor="middle" fontSize="10" fill="#d97706">費用収益対応</text>
          ...
          <text x="592" y="84" textAnchor="middle" fontSize="12" fontWeight="700" fill="#14532d">決算で</text>
          <text x="592" y="99" textAnchor="middle" fontSize="12" fontWeight="700" fill="#14532d">締める</text>
          <text x="592" y="116" textAnchor="middle" fontSize="10" fill="#15803d">経過勘定</text>
          <text x="592" y="131" textAnchor="middle" fontSize="10" fill="#15803d">決算整理仕訳</text>
          ...
          <text x="340" y="232" textAnchor="middle" fontSize="11" fill="#6d28d9">発生主義を理解 → 期またぎ問題を把握 → 当期分を正確に対応 → 決算で締める</text>
