      ...
      <div className="flex-1 border-2 border-orange-300 dark:border-orange-600 rounded-lg overflow-hidden">
        ...
        <div className="grid grid-cols-[90px_1fr_1fr] gap-0 border-b border-orange-200 dark:border-orange-700">
          ...
          <div className="bg-blue-50 dark:bg-blue-950 p-0.5 border-r border-blue-200 dark:border-blue-800 flex flex-col gap-0.5 text-center">
            <div className="bg-blue-100 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded py-1.5 text-[9px] text-blue-800 dark:text-blue-200 flex-1 flex items-center justify-center">固定費</div>
            <div className="bg-blue-100 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded py-1 text-[8px] text-blue-700 dark:text-blue-300 flex-1 flex items-center justify-center">・定型</div>
            <div className="bg-blue-100 dark:bg-blue-900 border border-blue-300 dark:border-blue-700 rounded py-1 text-[8px] text-blue-700 dark:text-blue-300 flex-1 flex items-center justify-center">・非定型→定型化</div>
          </div>
          <div className="bg-orange-50 dark:bg-orange-950 p-0.5 flex flex-col gap-0.5 text-center">
            <div className="bg-orange-200 dark:bg-orange-800 border border-orange-300 dark:border-orange-700 rounded py-1.5 text-[9px] text-orange-800 dark:text-orange-200 flex-1 flex items-center justify-center"></div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-[90px_1fr_1fr] gap-0">
          <div className="bg-yellow-100 dark:bg-yellow-900 p-1 flex items-center border-r border-orange-200 dark:border-orange-700">
            <div className="flex items-center gap-1">
              <span className="text-[9px] font-bold bg-yellow-500 text-white px-1 rounded">U</span>
          ...
          <div className="bg-yellow-50 dark:bg-yellow-950 p-0.5 border-r border-yellow-200 dark:border-yellow-800 flex flex-col gap-0.5 text-center">
            <div className="bg-yellow-100 dark:bg-yellow-800 border border-yellow-300 dark:border-yellow-700 rounded py-1.5 text-[9px] text-yellow-800 dark:text-yellow-200 flex-1 flex items-center justify-center">税引前利益</div>
          </div>
          <div className="bg-orange-50 dark:bg-orange-950 p-0.5 flex flex-col gap-0.5 text-center">
            <div className="bg-orange-200 dark:bg-orange-800 border border-orange-300 dark:border-orange-700 rounded py-1.5 text-[9px] text-orange-800 dark:text-orange-200 flex-1 flex items-center justify-center"></div>
          </div>
