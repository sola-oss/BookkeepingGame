  ...
  return (
    <div data-testid={`t-account-${account.name}`}>
      <div className={`border-2 rounded-md overflow-hidden transition-colors ${borderHighlight}`}>
        ...
        <div className="border-t border-slate-300 dark:border-slate-600 bg-slate-50 dark:bg-slate-800/50 text-[10px] md:text-[11px]">
          <div className="flex">
            <div className="flex-1 flex justify-between px-2 py-1 border-r border-slate-300 dark:border-slate-600">
...
export default function TAccountDiagram() {
  ...
  return (
    <div className="w-full p-4 md:p-6 space-y-4" data-testid="t-account-diagram">
      ...
      <p className="text-xs text-muted-foreground text-center">仕訳には4つの要素がある：日付・勘定科目・金額・摘要</p>
