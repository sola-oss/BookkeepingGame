          ...
          <div className="flex items-center justify-center gap-2 md:gap-3">
            <div className="border border-slate-200 dark:border-slate-700 rounded-lg bg-slate-50/60 dark:bg-slate-900/40 p-2 md:p-3 flex-shrink-0" data-testid="section-boki">
              ...
              <div className="flex items-center gap-1.5 md:gap-2">
                ...
                <div className="px-5 py-4 md:px-7 md:py-5 rounded-xl bg-amber-50 dark:bg-amber-950 shadow-lg flex-shrink-0" data-testid="box-kessan" style={{ borderWidth: "3px", borderColor: "rgb(251 191 36)", borderStyle: "solid" }}>
