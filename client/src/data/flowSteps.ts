...
export const flowSteps: FlowStep[] = [
  ...
  },
  {
    ...
    title: "勘定記入",
    subtitle: "Posting",
    description: "仕訳帳から「総勘定元帳」へ転記します。これにより科目ごとの1年間の動きと残高が明らかになります。また、現金出納帳・当座預金出納帳・売掛金元帳・買掛金元帳などの「補助元帳」も並行して記帳し、取引先別・口座別の詳細を管理します。",
    inLabel: ["仕訳"],
    outLabel: ["総勘定元帳", "補助元帳"],
    keyPoint: "総勘定元帳は全体の残高を、補助元帳は内訳（取引先別・口座別）を把握します。転記漏れがないか、期末に「試算表」を作成して確認します。",
    link: "/mock-exam",
    samples: [
      {
        type: "table",
      ...
      },
      {
        ...
        title: "主な補助元帳の種類",
        items: [
          { label: "現金出納帳", value: "現金の入出金を日付順に記録" },
          { label: "当座預金出納帳", value: "当座預金の入出金を記録" },
          { label: "売掛金元帳", value: "得意先別の売掛金残高を管理" },
          { label: "買掛金元帳", value: "仕入先別の買掛金残高を管理" }
        ]
      }
    ]
  },
