...
export const textbookChapters: TextbookChapter[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        id: "cross_period_transactions",
        title: "期をまたぐ取引",
        content: [
          "発生主義を採用すると、取引の「経済的な発生時点」と「現金の受払い時点」がずれることがあります。",
          "このズレが「期（会計期間）をまたぐ」と、当期の損益計算が複雑になります。",
          "具体例①　家賃の前払い：12月に翌年1〜3月分の家賃3万円を支払った場合、12月決算では3万円全額が当期の費用にはなりません。翌期分（1〜3月）は「前払費用」として次の期に繰り越す必要があります。",
          "具体例②　給料の未払い：3月末が決算で、3月分の給料20万円が4月に支払われる場合、3月の費用として20万円を計上しなければなりません。まだ払っていなくても、当期の費用として認識します。",
          "これらを放置すると、当期の損益が実態と異なってしまいます。",
          "だからこそ、次のセクション4〜7（期間損益計算・費用収益対応の原則・経過勘定・決算整理仕訳）が必要になります。",
        ],
      },
      {
